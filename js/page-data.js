let pageData = [
    ...
    },
    {
        ...
        title:'CTOMS',
        description:'This project was my first major web project. When I started the site was not mobile responsive and had many bugs, including one that was limiting customers from placing orders. I fixed up the existing site\'s bugs and then went to work setting up a Shopify site to replace the old site. This process required learning the Shopify framework along with their templating language, Shopify liquid. This Shopify store was also an enterprise version so that allowed us to setup custom checkout behaviour. This customized checkout experience was built with ruby. It was my first time working with ruby, but once I taught myself the basics, I was able to setup custom discounting and custom product availability based on each customer. The final piece of the integration was setting up the connection between the Shopify store and the backend Netsuite instance. In order to set this up I built a NodeJS server to handle orders from Shopify and create the orders on Netsuite as well it synched up inventories between the Shopify site and Netsuite. This also required building out various endpoints on Netsuite through their scripting language and API scripting language.',
    ...
    /*
    {
        ...
        title:'Whisk Co',
        description:'This was a project for a local bakery here that was looking to update their website. Initially the site was made with WordPress and had numerous mobile responsive issues. I fixed those issues and managed their website until they decided to get into online sales. I built their Shopify store and added in customizations to allow the store to work properly with a bakery. Some of these changes included, limiting delivery to specific locations, limiting delivery dates, and setting up product bundles for their cupcakes and cookies. I also trained the staff on the basics of Shopify which has allowed them to be self sustaining except for bigger site changes. They had a big online presence and with the online store their sales quickly doubled in the first few months. The store was also setup right before the pandemic hit and allowed them to stay open throughout the pandemic when other bakeries were struggling. They are now in the process of setting up a café and I am excited to help them transform their site to support that!',
        builtWith:'HTML, CSS, JavaScript, and Shopify',
